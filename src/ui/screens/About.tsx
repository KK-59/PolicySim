 ...
 *
 * Spacing follows one scale across every screen: 3rem above a section heading, 1rem below it,
 * 0.75rem between paragraphs, 1.5rem around a figure. Prose sits in `.measure`; figures use the
 * full page frame, which is also the frame the masthead uses, so nothing shifts sideways.
 */
    ...
    <section className="page">
      <div className="measure">
        ...
        <p className="lead mt-4">
          NHS-SIM lets you watch one version of a neighbourhood. It cannot tell you what a
          different one would have done. That is the gap this fills.
        </p>
        <p className="mt-3">
          Upload the policy document you already wrote. It is turned into engine parameters, each
          one carrying where it came from, and run forward{' '}
      ...
      <div className="measure mt-5">
        <p>
          Every number on screen says where it came from, and anything the evidence does not cover
          is flagged rather than quietly filled in.
        </p>
      </div>
      ...
      <div className="measure mt-7">
        <h2 className="h2">Why three worlds</h2>
        <p className="mt-4">
        ...
        <p className="mt-3">
          ...
          worst value together describes a future with almost no chance of happening, which makes
          it useless to plan against.
        </p>
      </div>
      ...
      <div className="measure mt-7">
        <h2 className="h2">What we claim</h2>
        <p className="mt-4">
          Never a single number. The output is a claim about direction, shape or threshold: better
          on average, worse for the complex tail, and only while community capacity holds.
        </p>
      </div>
      ...
      <div className="measure mt-5">
        <p className="muted">
          A conclusion that appears in only one world is labelled on screen and never presented as
          a result.
        </p>
      </div>

      <div className="measure mt-7">
        <h2 className="h2">The 10-Year Health Plan</h2>
        <p className="muted mt-4">
          Four chapters this is built against, and how each one shows up in the product.
        </p>
      </div>
      <dl className="boundaries measure mt-5">
        {CHAPTERS.map((c) => (
      ...
      <div className="measure mt-7">
        <h2 className="h2">Clinician mode</h2>
        <p className="muted mt-4">
          ...
          apply and verify loop behind it already works against the live world. The interface for
          it is not built yet.
        </p>
      </div>
    </section>
